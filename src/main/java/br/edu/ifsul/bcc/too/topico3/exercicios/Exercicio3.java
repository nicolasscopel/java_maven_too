...
public class Exercicio3 {
    ...
    public static void main(String[] args) {
        ...
        */
        System.out.println("rgDados1.length: "+ rgDados1.length);
        ...
        for (int linha=0; linha < rgDados1.length; linha++){
            ...
            for(int coluna=0; coluna < rgDados1[linha].length; coluna++){
                ...
                String d = JOptionPane.showInputDialog(null, "Informe um valor inteiro:", "Informe", JOptionPane.ERROR_MESSAGE);
                if(d == null){
                    break;
                }                
